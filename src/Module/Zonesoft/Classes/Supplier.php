...
/**
 * Class to List Suppliers
 */

class Supplier extends Authentication{
	...
	**/
	...
	{
        $GLOBALS['ACCESS'] = 'suppliers/getInstances';
    ...
    /**
    * Get a Client by is Code
    * @return json
    **/
    public function getSupplier()
    {
        $GLOBALS['ACCESS'] = 'suppliers/getInstance';
