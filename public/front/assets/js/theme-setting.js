(function ($) {
    ...
    $("#change-link").attr("href", localStorage.getItem('layoutcss') ? localStorage.getItem('layoutcss') : 'front/assets/css/style.css');
    ...
    $('#rtlButton').change(function () {
        if ($(this).is(":checked")) {
            $("html").attr("dir", "rtl");
            $("#rtl-link").attr("href", "front/assets/css/vendors/bootstrap.rtl.css");
            localStorage.setItem('rtlcss', 'front/assets/css/vendors/bootstrap.rtl.css');
            localStorage.setItem('dir', 'rtl');
        } else {
            $("html").attr("dir", '');
            localStorage.setItem('dir', '');
            $("#rtl-link").attr("href", "front/assets/css/vendors/bootstrap.css");
            localStorage.setItem('rtlcss', 'front/assets/css/vendors/bootstrap.css');
        }
    });
    $("html").attr("dir", localStorage.getItem('dir'));
    $("#rtl-link").attr("href", localStorage.getItem('rtlcss') ? localStorage.getItem('rtlcss') : 'front/assets/css/vendors/bootstrap.css');
